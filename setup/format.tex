...
% style
    frame=lines,%
    basicstyle={\linespread{0.9}\footnotesize\lstbasicfont}, % 行间距，字号，字体
...
%\cleardoublepage%
   \phantomsection
    ...
    \begin{titlepage}
      ...
      \begin{figure}[h]
      \centering
      \includegraphics[width=0.8\textwidth]{hitname.png}
      \end{figure}
      \vspace*{15pt}
      ...
      \begin{figure}[h]
      \centering
      \includegraphics[width=0.4\textwidth]{hitlogo.png}
      \end{figure}
      ...
      \begin{tabular}{lc}
        ...
        学 \qquad 号 &  \underline{\makebox[\@title@width][c]{\@cstuid}} \\
        任课教师 &  \underline{\makebox[\@title@width][c]{\@csupervisor}} \\
      \end{tabular}}}
      }
      \vspace*{21pt}
